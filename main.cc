...
public:
    ...
    MyWindow() {
        ...
        vbox->pack_start(this->selectButton, Gtk::PACK_SHRINK);
        vbox->pack_start(this->selectedFileLabel, Gtk::PACK_SHRINK);
        vbox->pack_start(this->renderButton, Gtk::PACK_SHRINK);
        vbox->pack_start(this->outputFileLabel, Gtk::PACK_SHRINK);
    ...
    void on_render_button_clicked()
    {
        ...
        dx->extractClip(seekTime, duration, outputPath);
